...
describe('auth: jwt.interceptor', () => {
  ...
  function genModule(options: AuthConfig, tokenData?: JWTTokenModel) {
    injector = TestBed.configureTestingModule({
      ...
      providers: [{ provide: AuthConfig, useValue: options }, { provide: HTTP_INTERCEPTORS, useClass: JWTInterceptor, multi: true }],
    });
